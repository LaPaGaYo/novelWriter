...
- Two providers in v1: **local** (Ollama, default model `llama3.1-8b` or user's choice)
  and **cloud BYO-key** (Anthropic, OpenAI, Gemini).
...
- Provider abstraction layer hides the difference from feature code. New providers added
  later do not require feature changes.
